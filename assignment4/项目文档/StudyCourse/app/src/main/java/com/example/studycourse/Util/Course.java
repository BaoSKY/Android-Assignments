...
public class Course {
    ...
    public Course(@NonNull String courseID, int imageId, String courseName, String teacher, String school, String courseDate, String courseDescription, String imageURL) {
